...
public class Main extends JFrame {
	...
	public Main() {
		...
		JLabel lblTitle = new JLabel("Tra-x: Expense Tracking System");
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (stringPrice.isEmpty()) {
					...
					try {
						...
						JOptionPane.showMessageDialog(Main.this, "Invalid price format"); // Kullanıcı sayı dışında başka bir şey girerse.
					}
				}
